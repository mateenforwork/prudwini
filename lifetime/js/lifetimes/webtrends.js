...
function WebTrends(){
	...
	this.dcsid="dcs8bjmh310000w454xrshw6g_8l4q";
	this.dcsProdDomains = [
    "lifetimes.bcbsil.com",
	"lifetimes.bcbsnm.com",
	"lifetimes.bcbsok.com",
	"lifetimes.bcbstx.com",
	"lifetimes.bcbsmt.com",
	"review-uat.lifetimes.bcbsil.com",
	"review-uat.lifetimes.bcbsnm.com",
	"review-uat.lifetimes.bcbsok.com",
	"review-uat.lifetimes.bcbstx.com",
	"review-uat.lifetimes.bcbsmt.com"
  ];
	...
	if (evt&&((typeof(evt.which)!="number")||(evt.which==1))){
		...
		if (e.href){
		    ...
		    if (this.dcsIsOnsite(hn)&&this.dcsTypeMatch(e.pathname,this.downloadtypes)){
		        var qry=e.search?e.search.substring(e.search.indexOf("?")+1,e.search.length):"";
		        var pth=e.pathname?((e.pathname.indexOf("index.html")!=0)?"/"+e.pathname:e.pathname):"/";
		        var ttl="";
...
WebTrends.prototype.dcsVar=function(){
	...
	WT.dl="0";
	WT.ssl=(window.location.protocol.indexOf('index.html')==0)?"1":"0";
...
WebTrends.prototype.dcsTag=function(){
	...
	var i18n=this.i18n;
	var P="http"+(window.location.protocol.indexOf('index.html')==0?'s':'')+"://"+this.domain+(this.dcsid==""?'':'/'+this.dcsid)+"/dcs.gif?";
	if (i18n){
		WT.dep="";
	}
	for (var N in DCS){
...
WebTrends.prototype.dcsDebug=function(){
	...
	var q=i.indexOf("?");
	var r=i.substring(0,q).split("index.html");
        ...
        if( shopIndex !== -1 ){
            if( scenarioSteps[shopIndex] === "10" ){
                ...
                if( retailCookiesExist ){
                    ...
                    var fqdPieces = this.WT.z_firstquotedate.split('index.html');
